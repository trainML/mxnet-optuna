...
Downloaded from: https://gluon-cv.mxnet.io/build/examples_datasets/pascal_voc.html#sphx-glr-build-examples-datasets-pascal-voc-py
...
def parse_args():
    ...
    parser.add_argument(
        "--no-download", action="store_true", help="disable automatic download if set"
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
